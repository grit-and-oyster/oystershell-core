...
global $ADODB_DATETIME_CLASS;
	...
	if ($ADODB_DATETIME_CLASS && $y !== false) {
		...
		$TZ = mktime(0,0,0,12,2,$y) - gmmktime(0,0,0,12,2,$y); // AMS modification to fix < The is_dst parameter is deprecated > error
	}
...
global $ADODB_DATETIME_CLASS;
	...
	*/
	for ($i=0; $i < $max; $i++) {
		...
		case 'S':
			$d10 = $day % 10;
			if ($d10 == 1 && $day != 11) $dates .= 'st'; //AMS fix for 11th
			else if ($d10 == 2 && $day != 12) $dates .= 'nd';
			else if ($d10 == 3 && $day != 13) $dates .= 'rd'; //AMS fix for 13th
			else $dates .= 'th';
			break;
